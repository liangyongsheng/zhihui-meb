...
public class MebPropertyDeleteRequest extends ApiRequest<MebPropertyDeleteResponse> {
	...
	@Override
	public Class<MebPropertyDeleteResponse> getResponseType() {
		return MebPropertyDeleteResponse.class;
	}
