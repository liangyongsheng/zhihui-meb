...
public class MebResetpwdResquest extends ApiRequest<MebResetpwdResponse> {
	private Long mebId;
	...
	@Override
	public Class<MebResetpwdResponse> getResponseType() {
		return MebResetpwdResponse.class;
	}
