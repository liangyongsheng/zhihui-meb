...
public class MebPropertyGetRequest extends ApiRequest<MebPropertyGetResponse> {
	private Long mebId;
	...
	@Override
	public Class<MebPropertyGetResponse> getResponseType() {
		return MebPropertyGetResponse.class;
	}
