...
public class TestMebAssetPointOwnershipSummaryRequest {
	...
	public static void main(String[] args) {
		...
		try {
			MebAssetPointOwnershipSummaryRequest t = new MebAssetPointOwnershipSummaryRequest();
			t.setMethod("meb.asset.point.ownership.summary");
