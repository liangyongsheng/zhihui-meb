...
public class TestMebAssetPointOwnershipGetRequest {
	...
	public static void main(String[] args) {
		...
		try {
			MebAssetPointOwnershipGetRequest t = new MebAssetPointOwnershipGetRequest();
			t.setMethod("meb.asset.point.ownership.get");
